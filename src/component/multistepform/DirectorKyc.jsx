        ...
        <div className='UploadCompanyVerify'>
            <form>
                <div className='CertificateContainer'>
                    <div className='UploadDocContainer' >
                        ...
                        <div className='uploadedDoc'>
                            {docUrl && <img src={docUrl} alt="Uploaded PAN" />} {/* Display the uploaded image */}
                        </div>
                    </div>
                </div>
                ...
                <div className='FormContainer'>
                    <TextField
                        id="outlined-basic" label="PAN Number" variant="outlined"
                        InputProps={{
...
export default DirectorKycVerfication